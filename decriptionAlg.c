...
//Collaboration with Deanna Harris
//Several stackoverflow pages referenced
...
int main(int argc, char *argv[])
{
  ...
  int i = 0;
  //Prep arrays by inserting null terminating strings in all indexes
  //for safety.
  ...
  //concatenates message into inputChars
   ...
   //Coppy inputChars back into message
